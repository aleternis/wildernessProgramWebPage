			...
			if ($result_event){
				while($row_event=mysql_fetch_array($result_event,MYSQL_NUM)){
						echo '<div id="joinEvent">';
							...
							echo '<div id="buttonPage"><a href="deleteEvent.php?eventId='.$row_event[0].'"><button class="buttonBackPage" type="button">Delete Event</button></a>';
							echo '<a href="peopleEvent.php?eventId='.$row_event[0].'"><button class="buttonBackPage" type="button">Show people in event</button></a></div>';
